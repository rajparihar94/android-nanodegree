package com.example.rajpa.otpverify.service;
...
import com.example.rajpa.otpverify.activity.MainActivity;
import com.example.rajpa.otpverify.app.Config;
import com.example.rajpa.otpverify.app.MyApplication;
import com.example.rajpa.otpverify.helper.PrefManager;
...
public class HttpService extends IntentService {
    ...
    private static String LOG_TAG = HttpService.class.getSimpleName();
    ...
    private void verifyOtp(final String otp) {
        StringRequest strReq = new StringRequest(Request.Method.POST,
            ...
            protected Map<String, String> getParams() {
                ...
                Log.e(LOG_TAG, "Posting params: " + params.toString());
                return params;
            }
